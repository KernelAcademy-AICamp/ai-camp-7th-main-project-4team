...
**화면 23개** · 🟡구현 13 · 🟠시안 6 · 🟢실연결 2 · 🟢완료 2 · ⚑ 이슈 0개 · 전체·비고·이동그래프 → [docs/화면-현황.md](docs/화면-현황.md)
...
| 관리자 · 이미지 붙여넣기 수집(3.A.1) | 🟡구현 | ✅ | `6844f8f` trubard·2026-07-13 | — |
...
| 관리자 · 사이즈/데이터(3.A) | 🟡구현 | ✅ | `85c65b7` trubard·2026-07-13 | — |
