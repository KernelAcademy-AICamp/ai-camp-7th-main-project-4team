...
| 화면 | 상태 | JS | 최근 변경 | 이슈 |
|---|---|---|---|---|
| 데모 초기화 | 🟡구현 | — | `0e3d5b0` trubard·2026-07-13 | — |
| 서비스 소개·작동원리 | 🟡구현 | — | `0e3d5b0` trubard·2026-07-13 | — |
| 결과 공유 카드 | 🟠시안 | ✅ | `0e3d5b0` trubard·2026-07-13 | — |
| 기본 정보 입력 | 🟡구현 | ✅ | `0e3d5b0` trubard·2026-07-13 | — |
| 착용경험 보정 입력 | 🟢실연결 | ✅ | `0e3d5b0` trubard·2026-07-13 | — |
| 진단 로딩 | 🟡구현 | ✅ | `0e3d5b0` trubard·2026-07-13 | — |
| 홈·허브(탭 홈/쇼퍼찾기/마이) | 🟡구현 | ✅ | `384dac4` trubard·2026-07-13 | — |
| 개인정보 처리방침 | 🟢완료 | — | `0e3d5b0` trubard·2026-07-13 | — |
| 견적 요청 | 🟡구현 | ✅ | `21cebf1` trubard·2026-07-13 | — |
| 쇼퍼 가입 | 🟡구현 | ✅ | `21cebf1` trubard·2026-07-13 | — |
| 쇼퍼 지원(공급자) | 🟡구현 | ✅ | `21cebf1` trubard·2026-07-13 | — |
| 진단 결과 | 🟢실연결 | ✅ | `0e3d5b0` trubard·2026-07-13 | — |
| 이용약관 | 🟢완료 | — | `0e3d5b0` trubard·2026-07-13 | — |
<!-- SCREENS:END -->
