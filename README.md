...
**화면 27개** · 🟡구현 18 · 🟠시안 5 · 🟢실연결 2 · 🟢완료 2 · ⚑ 이슈 0개 · 전체·비고·이동그래프 → [docs/화면-현황.md](docs/화면-현황.md)
...
| 자주 묻는 질문·도움말(G.2) | 🟡구현 | — | `34a747b` Sohee lee·2026-07-14 | — |
| 홈·허브(탭 홈/쇼퍼찾기/마이) | 🟡구현 | ✅ | `f15fd18` trubard·2026-07-14 | — |
| 개인정보 처리방침 | 🟢완료 | — | `2a3141c` trubard·2026-07-13 | — |
| 견적 요청 | 🟡구현 | ✅ | `3ea8575` geonhyoung·2026-07-14 | — |
| 쇼퍼 가입 | 🟡구현 | ✅ | `34a747b` Sohee lee·2026-07-14 | — |
| 쇼퍼 지원(공급자) 포털 | 🟡구현 | ✅ | `3ea8575` geonhyoung·2026-07-14 | — |
| 진단 결과 | 🟢실연결 | ✅ | `34a747b` Sohee lee·2026-07-14 | — |
