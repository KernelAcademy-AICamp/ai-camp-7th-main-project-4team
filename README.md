...
| 관리자 · 사업현황(3.C.1) — v2 | ⚪보류 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 · 이미지 붙여넣기 수집(3.A.1) | 🟡구현 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 · 진단 응답·정확도(3.C.2) | 🟢실연결 | ✅ | `9075dd7` Sohee lee·2026-07-24 | — |
| 관리자 · 엔진 시뮬레이터·튜닝(3.A.3) | 🟢실연결 | ✅ | `a0eac18` trubard·2026-07-24 | — |
| 관리자 · 브랜드·제품 실측표 CRUD(3.A.1) | 🟢실연결 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 · 엔진 강화(3.C.4) | 🟢실연결 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 · 전문가 수요(3.C.3) | 🟢실연결 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 로그인(구글 OAuth) | 🟢실연결 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 · 회원·거래(3.B) — v2 | ⚪보류 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 · 내부운영(3.E) — v2 | ⚪보류 | ✅ | `004ffed` trubard·2026-07-23 | — |
| 관리자 · 제출 사이즈표 검수 | 🟢실연결 | ✅ | `004ffed` trubard·2026-07-23 | — |
...
| 기본 정보 입력 | 🟡구현 | ✅ | `e8a84ce` trubard·2026-07-24 | — |
| 착용경험 보정 입력 | 🟢실연결 | ✅ | `e8a84ce` trubard·2026-07-24 | — |
| 진단 로딩 | 🟡구현 | ✅ | `e8a84ce` trubard·2026-07-24 | — |
| 자주 묻는 질문·도움말(G.2) | 🟡구현 | — | `e8a84ce` trubard·2026-07-24 | — |
| 홈·허브(탭 홈/쇼퍼찾기/마이) | 🟢실연결 | ✅ | `2b70b22` trubard·2026-07-24 | — |
| 구매 판정(Fit) | 🟢실연결 | ✅ | `e8a84ce` trubard·2026-07-24 | — |
...
| 진단 결과 | 🟢실연결 | ✅ | `e8a84ce` trubard·2026-07-24 | — |
