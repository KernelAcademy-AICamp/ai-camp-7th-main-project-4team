...
| 화면 | 상태 | JS | 최근 변경 | 이슈 |
|---|---|---|---|---|
| 오류·빈 상태(G.7) | 🟡구현 | — | `f7334e5` trubard·2026-07-14 | — |
...
| 관리자 · 엔진 시뮬레이터·튜닝(3.A.3) | 🟡구현 | ✅ | `f7334e5` trubard·2026-07-14 | — |
...
| 자주 묻는 질문·도움말(G.2) | 🟡구현 | — | `f7334e5` trubard·2026-07-14 | — |
| 홈·허브(탭 홈/쇼퍼찾기/마이) | 🟡구현 | ✅ | `f7334e5` trubard·2026-07-14 | — |
| 개인정보 처리방침 | 🟢완료 | — | `2a3141c` trubard·2026-07-13 | — |
| 견적 요청 | 🟡구현 | ✅ | `2a3141c` trubard·2026-07-13 | — |
| 쇼퍼 가입 | 🟡구현 | ✅ | `d859d1e` geonhyoung·2026-07-13 | — |
| 쇼퍼 지원(공급자) 포털 | 🟡구현 | ✅ | `2a3141c` trubard·2026-07-13 | — |
| 진단 결과 | 🟢실연결 | ✅ | `f7334e5` trubard·2026-07-14 | — |
