  ...
  var DEMO_REQS = [
    ...
    {cust:'서지호', type:'BAL', bodytype:'이지 밸런스',    gender:'male',   cm:176, kg:71, occ:'데일리',     budget:'5~10만',  date:'협의', service:'shopping', note:'날짜를 아직 못 정했어요 · 일정은 스타일리스트와 협의하고 싶어요', status:'신규'},
  ...
  var SVC_BY_CUST = {'한서준':'online','서지호':'shopping','김도현':'online','정예린':'shopping','이서연':'image','박지우':'online','최민준':'online','한지민':'online','윤채원':'online'};
