  ...
  /* 데모 시드 버전 — 결과물 작성·전달(2.1.2) 추가로 상태/서비스 모델이 바뀌어 옛 pro.reqs를 1회 자동 초기화 */
  if(loadLS('pro.reqsVer',0) < 2){ try{ localStorage.removeItem('fitting.pro.reqs'); }catch(e){} saveLS('pro.reqsVer',2); }
  ...
  var SVC_BY_CUST = {'김도현':'online','정예린':'shopping','이서연':'image','박지우':'online','최민준':'online'};
