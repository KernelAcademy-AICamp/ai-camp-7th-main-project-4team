  ...
  var MEAS={
    TOP:   [['shoulder','좁은 어깨','넓은 어깨','어깨 — 어깨 기준으로 사이즈가 갈려요'],
            ...
            // 배↔배둘레(미표기 부위·r²0.85). 기존엔 waist(허리)를 '배'로 표시하던 mislabel.
            ['belly','슬림한 배','볼륨 있는 배','배 — 로우라이즈·턱인 핏 기준'],
  ...
  function drawAvatar(forceCode){
    ...
    BodyModel.load().then(function(){
      ...
      // 신뢰도 라벨 = 표시되는 4개 부위 중 실제 역산된 개수(_ebKeys) 기준 — 탭4 부위별 신호와 일치(탭 간 모순 방지).
